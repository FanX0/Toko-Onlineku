                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <ul class="list-unstyled">
                            <li class="media">
                                <img src="/images/icon-testi1.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Sakura Chan</h5>
                            ...
                            <li class="media">
                                <img src="/images/icon-testi2.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Naruto Chan</h5>
                            ...
                            <li class="media">
                                <img src="/images/icon-testi3.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Sasuke Chan</h5>
    ...
    var gallery = new Vue({
        ...
        data: {
          ...
          photos: [
            {
              id: 1,
              url: "/images/product-d2.jpg",
            },
            {
              id: 2,
              url: "/images/product-d3.jpg",
            },
            {
              id: 3,
              url: "/images/product-d4.jpg",
            },
            {
              id: 4,
              url: "/images/product-d5.jpg",
            },
          ],
        },
        methods: {
